...
public class AppActivity extends AppCompatActivity implements FragmentTaskListInterface, FragmentCreateTaskInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestQueue = SingletonReqQueue.getInstance(getApplicationContext()).getRequestQueue();
    ...
    public void deleteTask(String jsonData) {
        ...
        try {
            ...
            idTarea = jsonObject.getInt("id");

        } catch (JSONException e) {
            throw new RuntimeException(e);
        }

        String url = "https://reseed-385107.ew.r.appspot.com/delete/typus/tarea/id/";
        ...
        saveTaskRequest.sendRequest(new VolleyResponseInterface() {
            ...
            public boolean onResponse(Object response) {
                ...
                Toast toast = Toast.makeText(getApplicationContext(), "Eliminando tarea.", Toast.LENGTH_SHORT);
                toast.show();
